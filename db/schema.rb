...
ActiveRecord::Schema.define(:version => 20130812012431) do
  ...
  add_index "taggings", ["tag_id", "taggable_id", "taggable_type", "tagger_id", "tagger_type", "context"], :name => "tagging_index", :unique => true
